      ...
      <div key={"row-item-0"} className={cls} id={question["@id"]}>
        <div className="question-with-unit">
          ...
          <div className="unit-question">
            <Question
              question={unitQuestion.q}
              onChange={this._onUnitQuestionChange}
              index={unitQuestion.index}
            />
          </div>
        </div>
      </div>,
...
const QuestionWithUnit = (props) => {
  ...
  return <_QuestionWithUnit formData={formData} {...props} />;
};
